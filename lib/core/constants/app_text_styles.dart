...
class AppTextStyles {
  ...
  static TextStyle get bold24Primary => _baseStyle.copyWith(
    fontSize: size24,
    fontWeight: bold,
    color: AppColors.primary,
  );

  static TextStyle get bold32TextSecondary => _baseStyle.copyWith(
    fontSize: size32,
    fontWeight: bold,
    color: AppColors.textSecondary,
  );

  static TextStyle get bold32 => _baseStyle.copyWith(
    fontSize: size32,
    fontWeight: bold,
    color: AppColors.textPrimary,
  );

  static TextStyle get medium16 => _baseStyle.copyWith(
    fontSize: size16,
    fontWeight: medium,
    color: AppColors.textPrimary,
  );

  static TextStyle get medium16White => _baseStyle.copyWith(
    fontSize: size16,
    fontWeight: medium,
    color: AppColors.white,
  );

  static TextStyle get medium14TextSecondary => _baseStyle.copyWith(
    fontSize: size14,
    fontWeight: medium,
    color: AppColors.textSecondary,
  );

  static TextStyle get medium14Primary => _baseStyle.copyWith(
    fontSize: size14,
    fontWeight: medium,
    color: AppColors.primary,
  );

  static TextStyle get bold24 => _baseStyle.copyWith(
    fontSize: size24,
    fontWeight: bold,
    color: AppColors.textPrimary,
  );
